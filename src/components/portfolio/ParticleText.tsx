...
/**
 * ParticleText (React Bits) - samples a word into a field of particles that
 * scatter and reform. Ported to TypeScript; behaviour matches the upstream
 * JavaScript + CSS variant.
 */
...
const waitForFonts = async (font: string) => {
  ...
  try {
    ...
    /* font may be unavailable; sampling still works with the fallback */
  }
...
export type ParticleTextProps = {
  ...
  particleSize?: number;
  /** Pixel sampling step for the offscreen glyph canvas. Lower means more particles. */
  density?: number;
  /** Primary particle color. */
  color?: string;
  /** Secondary color blended through the particle field. */
  highlightColor?: string;
  /** How far particles begin from their final glyph targets. */
  scatter?: number;
  /** Milliseconds for particles to converge into the text. */
  gatherDuration?: number;
  /** Maximum per-particle delay in milliseconds before gathering. */
  stagger?: number;
  /** Strength of the cursor pushback. */
  pointerRepel?: number;
  ...
  /** Canvas text size used for glyph sampling. */
  fontSize?: number | string;
  /** Font weight used for sampling. */
  fontWeight?: number | string;
  /** Font family used for sampling. `inherit` waits for the surrounding font. */
  fontFamily?: string;
  /** Adds a soft particle bloom in the highlight color. */
  glow?: boolean;
  className?: string;
  style?: CSSProperties;
};
